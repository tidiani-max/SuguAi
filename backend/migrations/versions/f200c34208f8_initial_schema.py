...
def upgrade() -> None:
    ...
    op.create_table('businesses',
        ...
        sa.Column('business_type', sa.Enum('products_seller','service_information','transport','health','education','real_estate','events', name='businesstype'), nullable=False),
        ...
        sa.Column('status', sa.Enum('not_connected','connected','suspended', name='businessstatus'), nullable=False),
    ...
    op.create_table('promotions',
        ...
        sa.Column('status', sa.Enum('draft','scheduled','sending','sent','cancelled', name='promotionstatus'), nullable=True),
    ...
    op.create_table('conversations',
        ...
        sa.Column('state', sa.Enum('browsing','awaiting_payment','payment_verification','completed','human_takeover', name='conversationstate'), nullable=False),
    ...
    op.create_table('messages',
        ...
        sa.Column('message_type', sa.Enum('text','image','audio','document','interactive', name='messagetype'), nullable=True),
    ...
    op.create_table('orders',
        ...
        sa.Column('status', sa.Enum('pending_payment','paid','processing','shipped','delivered','cancelled', name='orderstatus'), nullable=False),
